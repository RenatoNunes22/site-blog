...
export const SupportSection = () => {
  return (
    <section className="relative pb-8 md:py-10 bg-gray-700">
      <div className="absolute inset-0 hidden md:block bg-[url('/background-features.png')] bg-cover bg-center bg-no-repeat opacity-90" />
      ...
      <div className="container flex flex-col items-center gap-12 relative">
        <h2 className="font-sans text-balance text-center text-heading-xl text-gray-100">
          Your affiliate store, simple, as it should be
        </h2>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-blue-400">
            ...
            <strong className="text-heading-sm text-gray-100">Customize your site</strong>
            <p className="text-body-sm text-gray-200">
              Add your logo, favicon, colors to your catalog and have everything your way.
            </p>
          </div>
          ...
          <div className="flex flex-col text-left gap-2 rounded-lg p-6 md:p-12 bg-cyan-300">
            ...
            <strong className="text-heading-sm text-gray-100">Sell from any store</strong>
            <p className="text-body-sm text-gray-200">
